...
// Optional
// Use pagination on the services page.
// Show the rating with star icons in a user review
// Try to use a better-looking confirmation dialogue other than the browser's default confirm.
// On the add a service page, try to implement direct image upload from your computer. This image can be hosted on a third party image hosting like imgbb or directly to mongodb
// Add some animation while applicable.
// Please Use icons whenever applicable and use fonts (google fonts)
// Make the footer a little more realistic with the copyright symbol and year.
// Optimize your images
// Add something extra of your own. This will help you in the future.
// Additional information:
// You can use vanilla CSS, any CSS library, framework, or component library you want.
// If possible, try another component library other than daisyUI
// If needed, you can mix a CSS framework with a component library
// You may use react hook form, basic html form or any library for authentication
// Store JWT token in http only cookie (alternatively, feel free to store it in the Local storage for this assignment)
// Try to host your site on Firebase (Netlify host will need extra configuration)
// Try to host the server on Vercel
// What to submit
